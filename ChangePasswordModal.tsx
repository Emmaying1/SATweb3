...
const InputField: React.FC<{
    ...
    <div>
        ...
        <input
            ...
            className={`mt-1 w-full bg-slate-100 dark:bg-slate-700 border rounded-md py-2 px-3 text-slate-900 dark:text-white font-mono text-sm ${error ? 'border-red-500' : 'border-slate-200 dark:border-slate-600'}`}
        />
...
const ChangePasswordModal: React.FC<ChangePasswordModalProps> = ({ onClose, onSuccess }) => {
    ...
    const validate = () => {
        ...
        else if (newPassword.length < 8) newErrors.new = 'Password must be at least 8 characters long.';
        ...
        >
            ...
            >
                <div className="p-4 border-b border-slate-200 dark:border-slate-700 flex justify-between items-center">
                    <h2 id="change-password-modal-title" className="text-lg font-bold text-slate-900 dark:text-white flex items-center gap-2">
